    ...
    function ShoppingListDirective() 
    {
        var ddo = {
            ...
            scope: {
                items: '<',
                title: '@title',
                badRemove: '=', // with bad remove, we are yanking the removeItem from the parent controller context and putting it into this directive controller's context, which prevents us from actually changing the list owned by our parent controller!
                onRemove: '&'
            }, 
